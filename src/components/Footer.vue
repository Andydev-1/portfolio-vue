      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 lg:col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-2xl font-bold">AutoLux</span>
          </div>
          <p class="text-gray-300 mb-6 max-w-md">
            Your premier destination for luxury and premium vehicles. We connect car enthusiasts with their perfect ride through cutting-edge technology and exceptional service.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <router-link to="/cars" class="text-gray-300 hover:text-white transition-colors">
                Browse Cars
              </router-link>
            </li>
            <li>
              <router-link to="/featured" class="text-gray-300 hover:text-white transition-colors">
                Featured Vehicles
              </router-link>
            </li>
            <li>
            ...
            <li>
              <router-link to="/cart" class="text-gray-300 hover:text-white transition-colors">
                Shopping Cart
              </router-link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-gray-300">info@autolux.com</span>
            </div>
